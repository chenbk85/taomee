        ...
        if ((i == 0) || newline(p[i-1])) {
            ...
            if(left_barce(p[i])) {
                ...
                *sec_e = i - 1;
                ...
                /// 删除 section 首尾的空格
                trim_token(sec_s, sec_e);

                if((strlen(section) == (size_t)(*sec_e - *sec_s + 1)) && (strncmp(p + *sec_s, section, *sec_e - *sec_s + 1) == 0)) {
                    int newline_start = 0;
                            ...
                            while(j < i && p[j] != '=') {
                                ...
                                if('=' == p[j]) {
                                    ...
                                    *key_e = j-1;
                                    ...
                                    /// 删除 key 首尾的空格
                                    trim_token(key_s, key_e);

                                    if((strlen(key)==(size_t)(*key_e - *key_s + 1)) &&
                                            (strncmp(key, p + *key_s, *key_e - *key_s + 1)==0)) {
                                        *value_s = j+1;
                                        *value_e = i-1;
