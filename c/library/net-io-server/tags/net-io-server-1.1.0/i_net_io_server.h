...
public:
     ...
     */
    virtual int on_new_connection(void *p_net_io_server, const int connection_id, const char *peer_ip, const int peer_port) = 0;
     ...
     * @return  0success -1failed
     */
    virtual int on_recv_data(void *p_net_io_server, const int connection_id, char *p_data, int data_len) = 0;
     ...
     * @return  0success -1failed
     */
    virtual int on_connection_closed(void *p_net_io_server, const int connection_id) = 0;
};
...
struct i_net_io_server
{
     ...
     */
    virtual int init(const char *listen_ip, const int listen_port, const i_net_io_server_events *p_events) = 0;
     ...
     * @return  0success -1failed
     */
    virtual int get_connection_info(const int connection_id, char *server_ip, int ip_buffer_len, int *p_port, int *p_connected_time) = 0;
