...
int net_io_notifier_create(i_net_io_notifier **pp_net_io_notifier)
{
    ...
    i_net_io_notifier *p_net_io_notifier
        = new (std::nothrow) c_net_io_notifier();
...
c_net_io_notifier::c_net_io_notifier()
    :m_init_(0)
{
}
...
int c_net_io_notifier::init()
{
    ...
    int *p_mutex = reinterpret_cast<int *>(
                       mmap(NULL,
                            sizeof(int),
