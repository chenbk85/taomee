...
uint8_t         ignore_project[MAX_PROJECT_NUMBER];
...
uint32_t		cdn_max_speed = 0xFFFFFFFF;		//
//uint32_t		cdn_speed_dis[4] = {50,100,150,200};//-1, [0-50), [50-100),[100-150),[150-200) [200->>)
uint32_t		cdn_speed_dis[4] = {50,101,161,221};

char			idc_file_dirpath[DIR_PATH_LEN] = "/home/probe_ip_save";
char			idc_rename_dirpath[DIR_PATH_LEN] = "/home/probe_ip_save_renamed";
char			mmap_tmpfile_dirpath[DIR_PATH_LEN] = "/home/analyze_server/tmp";
