...
#define		CDN_SPEED_INVALID		((uint32_t)(-1))
...
typedef struct mmap_head{
	...
	uint32_t	value;			//其他mmap保留，url的mmap用来记录pageid对应的具体mmap索引0-100
