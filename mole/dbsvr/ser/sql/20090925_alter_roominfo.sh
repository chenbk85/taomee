...
#		add  candy INT UNSIGNED NOT NULL DEFAULT 0,
#		add  score INT UNSIGNED NOT NULL DEFAULT 0,
#		add  total_score INT UNSIGNED NOT NULL DEFAULT 0,
#		add  catch_candy INT UNSIGNED NOT NULL DEFAULT 0;
		drop  day_medal;
EOF
}
