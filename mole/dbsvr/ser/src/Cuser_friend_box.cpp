...
Cuser_friend_box::Cuser_friend_box(mysql_interface * db)
	:CtableRoute100x10(db, "USER", "t_user_friend_box", "userid")
{
}

int Cuser_friend_box::init_record(userid_t userid)
{
...
int Cuser_friend_box::get_item_list(userid_t userid,get_friend_box_items_out *p_out)
{
...
int Cuser_friend_box::set_item_list(userid_t userid,get_friend_box_items_out *p_out)
{
...
int Cuser_friend_box::get_history_list(userid_t userid,get_friend_box_history_out *p_out)
{
...
int Cuser_friend_box::set_history_list(userid_t userid,get_friend_box_history_out *p_out)
{
...
int Cuser_friend_box::get_share_src_list(userid_t userid,uint32_t &date,share_src_t *p_out)
{
...
int Cuser_friend_box::set_share_src_list(userid_t userid,uint32_t date,share_src_t *p_out)
{
