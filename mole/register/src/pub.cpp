 ...
 *
 *        Version:  1.0
 *        Created:  02/26/2008 03:47:55 PM EST
 *       Revision:  none
 *       Compiler:  gcc
...
int cpEncodeBase64(const unsigned char *sSrc, unsigned char *sTarget, const int nSize)
{
...
int cpDecodeBase64(const unsigned char *sSrc, unsigned char *sTarget, const int nSize)
{
    int
...
static void init_conversion_tables(void)
{
    ...
    base64_to_char [62]  = '+';
    base64_to_char [63]  = '/';
    char_to_base64 [(int)'+'] = 62;
    char_to_base64 [(int)'/'] = 63;
