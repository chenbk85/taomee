...
require Exporter;
our @ISA =qw(Exporter);
our @EXPORT =qw($main_login_sock $mole_login_sock $online_sock $recvbuf $length $cmdid $uid $result 
...
#login
	#send a request
	$sendbuf = pack("NcN3 a32N2", 57, 1, 104, $login_uid, 0, 'a420384997c8a1a93d5a84046117c2aa', 9, 1);
...
sub get_mole_recommended_svr_list
{
	...
	$login_uid = $_[0];
	#send a request
	$sendbuf = pack("NcN3 a16", 33, 1, 105, $login_uid, 0, $sess_body);
