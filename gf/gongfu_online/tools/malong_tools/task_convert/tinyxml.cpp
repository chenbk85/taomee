...
const char * TiXmlElement::Attribute( const char * name, int* i, const int default_value) const
{
...
const char * TiXmlElement::Attribute( const char * name, double* d, const double default_value) const
{
	const char * s = Attribute( name );
	if ( d )
	{
