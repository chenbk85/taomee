...
public:
	...
	*/
	...
	/** Given an attribute name, Attribute() returns the value
		...
		is non-null.
	*/
	const char* Attribute( const char* name, int* i, const int default_value = 0) const;
	...
	/** Given an attribute name, Attribute() returns the value
		...
		is non-null.
	*/
	const char* Attribute( const char* name, double* d, const double default_value = 0) const;
