...
int my_read_conf()
{
    ...
    strcpy(my_opt.gf_dbproxy_ip, config_get_strval("gf_dbproxy_ip"));
    my_opt.gf_dbproxy_port = config_get_intval("gf_dbproxy_port", 0);

    strcpy(my_opt.gf_deluser_ip, config_get_strval("gf_deluser_ip"));
    my_opt.gf_deluser_port = config_get_intval("gf_deluser_port", 0);
