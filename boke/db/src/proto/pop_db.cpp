...
bool  pop_get_all_info_out::read_from_buf(byte_array_t & ba ){
	...
	if (item_day_list_count>9999) return false;
	...
	if (find_map_list_count>9999) return false;
	...
	if (user_log_list_count>9999) return false;
	...
	if (game_info_list_count>9999) return false;
...
bool pop_get_all_info_out::write_to_buf(byte_array_t & ba ){
	...
	if (this->item_list.size()>9999 ) return false;
	...
	if (this->item_day_list.size()>9999 ) return false;
	...
	if (this->find_map_list.size()>9999 ) return false;
	...
	if (this->user_log_list.size()>9999 ) return false;
	...
	if (this->game_info_list.size()>9999 ) return false;
...
bool  pop_set_item_used_list_in::read_from_buf(byte_array_t & ba ){
	...
	if (del_can_change_list_count>9999) return false;
	...
	if (set_noused_list_count>9999) return false;
	...
	if (add_can_change_list_count>9999) return false;
	...
	if (set_used_list_count>9999) return false;
...
bool pop_set_item_used_list_in::write_to_buf(byte_array_t & ba ){
	if (this->del_can_change_list.size()>9999 ) return false;
	...
	if (this->set_noused_list.size()>9999 ) return false;
	...
	if (this->add_can_change_list.size()>9999 ) return false;
	...
	if (this->set_used_list.size()>9999 ) return false;
