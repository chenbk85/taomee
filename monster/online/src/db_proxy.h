...
int process_select_denote_return(usr_info_t *p_user, svr_msg_header_t *p_db_pkg);
int process_select_history_denote_return(usr_info_t *p_user, svr_msg_header_t *p_db_pkg);
int process_denote_coins_return(usr_info_t *p_user, svr_msg_header_t *p_db_pkg);
