...
#	`/home/kal/send_short_message/sendsms 13585574642,15202115826,13761071357,13621606625,13917927682 "$core_file_cnt db core! @msg_arr"`;
	`/home/kal/send_short_message/sendsms 13917927682,13585574642 "$core_file_cnt db core! @msg_arr"`;
}
