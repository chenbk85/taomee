...
CREATE TABLE IF NOT EXISTS `mole_main_anticheat` ( /* 上报记录 */
...
CREATE TABLE IF NOT EXISTS `mole_today_anticheat` ( /* 上报记录 */
	`id` BIGINT UNSIGNED PRIMARY KEY NOT NULL AUTO_INCREMENT,
	`tw_ill_code` INT UNSIGNED NOT NULL,
	`sw_ill_code` INT UNSIGNED NOT NULL,
	`uid` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mole_tw_config` ( /* tw 配置 */
...
CREATE TABLE IF NOT EXISTS `mole_sw_config` ( /* sw 配置 */
