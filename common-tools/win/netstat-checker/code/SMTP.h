...
#if !defined(AFX_SMTP_H__4055D6DD_2A3F_46D7_B0A7_CA56581C9CEA__INCLUDED_)
#define AFX_SMTP_H__4055D6DD_2A3F_46D7_B0A7_CA56581C9CEA__INCLUDED_
...
private:	
	CSmtpError m_oError;
	char m_szLocalHostName[128];
	char m_szMailFrom[128];
	char m_szNameFrom[128];
	char m_szSubject[128];
	char m_szMsgBody[MAX_MSG_LEN];
	char* m_pcXMailer;
	char m_szReplyTo[128];
	char* m_pcIPAddr;
	char m_szLogin[128];
	char m_szPassword[128];
	char m_szSMTPSrvName[64];
...
#endif // !defined(AFX_SMTP_H__4055D6DD_2A3F_46D7_B0A7_CA56581C9CEA__INCLUDED_)
